...
<div id="bbs">
	...
	<div id="bbsCreated">
		...
		<dl>
			<dt>패스워드</dt>
			<dd><input type="text" name="userPwd" size="35" maxlength="20" 
			value="${dto.userPwd }" class="boxTF"/></dd>
		</dl>
		</div>
		...
		<dl>
			<dt>생&nbsp;&nbsp;&nbsp;&nbsp;일</dt>
			<dd><input type="text" name="userBirth" size="35" maxlength="50" 
			value="${dto.userBirth }" class="boxTF"/>[YYYY-MM-DD]</dd>
		</dl>
		</div>
		...
		<dl>
			<dt>전&nbsp;&nbsp;&nbsp;&nbsp;화</dt>
			<dd><input type="text" name="userTel" size="35" maxlength="50" 
			value="${dto.userTel }" class="boxTF"/></dd>
		</dl>
		</div>
